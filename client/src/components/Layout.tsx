      ...
      <nav className={`nav-fixed${scrolled ? " scrolled" : ""}`}>
        <div className="nav-topbar">
          <div className="topbar-socials">
            ...
            <a href="https://www.instagram.com/deo_conseil?igsh=c25oeTg1bHpsdnF2" target="_blank" rel="noreferrer" className="s-ig" title="Instagram">
            ...
            <a href="https://www.facebook.com/share/1L86oS9gLC/?mibextid=wwXIfr" target="_blank" rel="noreferrer" className="s-fb" title="Facebook">
